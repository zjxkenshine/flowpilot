// sidepanel/ip-proxy-provider-711proxy.js — 711Proxy 面板专属逻辑与 API URL 规则
(function register711ProxyPanelProvider(root) {
  ...
  function parse711ProxyApiConfigFromUrl(apiUrl = '') {
    ...
    return {
      ...
      region: normalizeIpProxyCountryCode(urlObject.searchParams.get('region') || ''),
  ...
  publish711PanelExports({
    ...
    infer711RegionFromHost,
    infer711RegionFromUsername,
